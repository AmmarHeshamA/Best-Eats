...
function Navbar() {
  ...
  return (
        <div className='flex justify-between
            items-center p-4 mx-auto max-w-[1640px]'>
            ...
            <div className='flex items-center'>
                ...
                rounded-full p-1 text-[14px]'>
                    <p className='p-2 bg-black rounded-full text-white'>Delevery</p>
            ...
            <div className='flex items-center  px-4 bg-gray-200 rounded-full
            w-[200px] sm:w-[400px]  lg:w-[500px]'>
                <AiOutlineSearch size={25}/>
                <input type="text" className='bg-transparent p-2
                w-full focus:outline-none ' placeholder="Search foods"/>
            </div>
